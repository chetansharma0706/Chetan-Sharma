        ...
        <div className="home__content grid">
          ...
          <div className="home__data">
            ...
            <p className="home__description">
              Full Stack Developer (B.Tech CSE, 2026) with hands-on experience building scalable web applications and AI-integrated
              platforms. Proficient in JavaScript, TypeScript, React, Next.js, Tailwind CSS, Prisma, and Supabase, with strong
              foundations in Java (DSA).
            </p>
